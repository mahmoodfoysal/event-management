            ...
            <div className="w-full lg:w-1/3 space-y-12">
              <div>
                ...
                <p className="text-slate-500 font-medium">
                  Reach out to our strategic planning team to discuss your next
                  world-class event.
                </p>
              </div>
                ...
                <div className="p-6 bg-slate-50 rounded-[2rem] border border-slate-100">
                  ...
                  <div className="space-y-2 text-sm text-slate-500 font-medium">
                    <div className="flex justify-between">
                      <span>Mon - Thu:</span> <span>09:00 - 18:00</span>
                    </div>
                    <div className="flex justify-between border-t border-slate-200 pt-2">
                      <span>Friday:</span> <span>Closed</span>
                    </div>
                    <div className="flex justify-between border-t border-slate-200 pt-2">
                      <span>Sat - Sun:</span> <span>10:00 - 15:00</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="input input-bordered w-full bg-slate-50 border-slate-200 rounded-2xl focus:border-orange-500 focus:outline-none h-14"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[11px] font-black uppercase tracking-widest text-slate-400 px-1">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="textarea textarea-bordered w-full bg-slate-50 border-slate-200 rounded-2xl focus:border-orange-500 focus:outline-none py-4"
                    ></textarea>
                  </div>

                  <button
                    type="submit"
                    className="btn btn-primary w-full h-16 rounded-2xl text-white font-bold text-lg shadow-lg shadow-orange-100 group transition-all"
                  >
                    Send Message
                    <svg
