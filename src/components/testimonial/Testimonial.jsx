...
const Testimonial = () => {
  ...
  const data = [
    {
      ...
      quote: "Their team didn't just manage our event; they amplified our brand's global presence.",
    ...
    },
    {
      ...
      quote: "The digital experience they built for our summit was flawlessly executed and highly intuitive.",
    ...
    },
    {
      ...
      quote: "Working with them felt like having an elite strategic partner, not just a service provider.",
    ...
    },
    {
      ...
      quote: "They turned a complex multi-layered filtering logic into a seamless user journey.",
    ...
    },
    {
      ...
      quote: "Their logistics planning is world-class. No detail was too small for their professional team.",
  ...
  }, [active, isPaused]); // Dependencies are correct here
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            <div className="space-y-2 border-l-4 border-orange-500 pl-6 animate-slide-up">
              ...
              <p className="text-slate-500 font-medium uppercase tracking-widest text-sm">
                {data[active].role} — <span className="text-slate-900">{data[active].company}</span>
              </p>
            </div>
            ...
            <div className="pt-6 flex items-center gap-8">
              <div className="flex gap-4">
                <button onClick={handlePrev} className="btn btn-circle btn-outline border-slate-200 hover:bg-slate-900 hover:text-white transition-all">
                  ❮
                </button>
                <button onClick={handleNext} className="btn btn-circle bg-orange-500 border-none text-white hover:bg-orange-600 transition-all">
                  ❯
                </button>
              </div>
